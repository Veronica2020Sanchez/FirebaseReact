...
import { loginWithCredentials, logoutFirebase, onAuthStateHasChanged, signInWithCredentials, singInWithGoogle } from '../firebase/provider';
...
export const AuthContext = createContext({
    ...
    handleLoginWithCredentials: (password, email) => {},
    handleRegisterWithCredentials: (password, email) => {},
    handleLogOut: () => {}
});
